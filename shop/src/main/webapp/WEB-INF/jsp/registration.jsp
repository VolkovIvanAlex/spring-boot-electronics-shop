...
<div class="registration">
    <form:form
        ...
        <form:input cssClass="input-registration" path="firstName" type="text" placeholder="Ivan" required="true"/>
        <form:errors path="firstName" cssStyle="background: #ff704d;border-radius: 5px"/>
        <br>
        <br>
        <label>Enter Last Name (Only Letters)</label>
        <form:input cssClass="input-registration" path="lastName" type="text" placeholder="Volkov" required="true"/>
        ...
        <form:input cssClass="input-registration" path="birthDay" type="text" required="true" placeholder="08-12-2002"/>
        <form:errors path="birthDay" cssStyle="background: #ff704d;border-radius: 5px"/>
        <br>
        <br>
        <label>Enter phone (only 10 digits)</label>
        <form:input cssClass="input-registration" path="phone" type="number" required="true" placeholder="**********"/>
