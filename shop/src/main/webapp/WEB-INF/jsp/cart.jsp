                    ...
                    <div>
                        <h2 style="display: inline-block;">
                            ...
                            <a style="text-decoration: none" href="/product/${cartEntry.productDTO.code}">
                                (${cartEntry.productDTO.code}) ${cartEntry.productDTO.name}
                                (${cartEntry.productDTO.price}$)
                            </a>
                            <form:form
                                ...
                                <input class="input" type="number" name="productCode"
                                       value="${cartEntry.productDTO.code}"
                                       hidden/>
