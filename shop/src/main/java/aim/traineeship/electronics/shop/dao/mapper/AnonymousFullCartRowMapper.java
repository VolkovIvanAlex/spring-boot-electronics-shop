...
public class AnonymousFullCartRowMapper implements RowMapper<Cart>
{
	...
	{
		final AnonymousCartRowMapper anonymousCartRowMapper = new AnonymousCartRowMapper();
		final Cart cart = anonymousCartRowMapper.mapRow(rs, rowNum);
